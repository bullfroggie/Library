...
def prijava_korisnik():
    ...
    # If login isn't successful, the program asks whether the person..
...
def pregled_zaduzenih_knjiga():
    # Function for showcasing indebted books for the currently logged in user
...
def pretrazivanje_knjiga():
    ...
    # and if so, how much. It also tell the user whether there aren't any copies available at the moment
...
def prikaz_korisnika(korisnik):
    # Function for printing users that are used inside of a for loop
        ...
        for prijavljen in trenutno_prijavljen:
            if prijavljen["korisnicko_ime"] == korisnik["korisnicko_ime"]:
                ...
                if promena == "1":
                    ...
                    print("\nUneli ste nepostojeci broj. Povratak na glavni meni.")
